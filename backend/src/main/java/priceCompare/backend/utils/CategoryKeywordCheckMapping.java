...
public class CategoryKeywordCheckMapping {
    public static final Map<Subcategory, List<String>> categoryMap = Map.<Subcategory, List<String>>ofEntries(
            ...
            Map.entry(SILIKAATPLOKK, List.of("silikaatplokk")),
            Map.entry(LAKKAPLOKK, List.of("lakkaplokk")),
            ...
            Map.entry(EPS,  List.of("EPS", "vahtplast")),
            Map.entry(PIR, List.of("pir")),
            ...
            Map.entry(PUITVOODRILAUAD, List.of("puit voodrilaud", "puidu vood")),
            Map.entry(TSEMENTVOODRILAUAD, List.of("tsement vood")),
            Map.entry(PLASTVOODER, List.of("plast vood")),
            Map.entry(FASSAAD_PLAADID, List.of("fassaadi plaa")),
            Map.entry(PROFIILID, List.of("profiil")),
            Map.entry(FASSAAD_TARVIKUD, List.of("tarvik")),

            Map.entry(KIVI, List.of("katusekivi", "kivikatus")),
            Map.entry(TERAS, List.of("plekkkatus", "teraskatus")),
            Map.entry(ETERNIIT, List.of("eterniit")),
            Map.entry(BITUUMEN, List.of("bituumen")),
            Map.entry(PVC_PC, List.of("pvc")),
            Map.entry(VIHMAVEESUSTEEMID, List.of("vihma")),
            Map.entry(KATUSETARVIKUD, List.of("katus")),

            Map.entry(EHITUSPABER, List.of("paber")),
            Map.entry(KANGAD, List.of("kangas")),
            Map.entry(KILED, List.of("kile")),
            Map.entry(AURUTOKE, List.of("aurutõke")),
            Map.entry(GEOTEKSTIIL, List.of("geotekstiil")),
            Map.entry(KATUSE_ALUSKATE, List.of("aluskate")),

            Map.entry(ARMATUUR, List.of("armatuur")),
            Map.entry(PLEKKPROFIILID, List.of("profiil"))
    );
}
