...
public enum Subcategory {
    ...
    OSB_PLAAT("OSB-plaat", new Filter[]{OSB_KLASS, OSB_TUUP, OSB_LABIMOOT, OSB_LAIUS_PIKKUS}),
    VINEER("Vineer", new Filter[]{VINEER_TUUP, VINEER_MATERJAL, VINEER_LABIMOOT, VINEER_LAIUS_PIKKUS}),
